...
public class OnlineMapsTilesetControlEditor : OnlineMapsTextureControlEditor
{
    ...
    private void DrawMaterialsAndShaders()
    {
        ...
        if (showShaders)
        {
            tilesetControl.tileMaterial =
                (Material)
                    EditorGUILayout.ObjectField("Tile material: ", tilesetControl.tileMaterial, typeof (Material), false);
            tilesetControl.markerMaterial =
                EditorGUILayout.ObjectField("Marker Material:", tilesetControl.markerMaterial, typeof(Material), false) as Material;
            tilesetControl.tilesetShader =
                EditorGUILayout.ObjectField("Tileset Shader:", tilesetControl.tilesetShader, typeof (Shader), true) as
                    Shader;
            tilesetControl.markerShader =
                EditorGUILayout.ObjectField("Marker Shader:", tilesetControl.markerShader, typeof (Shader), false) as Shader;
            tilesetControl.drawingShader =
                EditorGUILayout.ObjectField("Drawing Shader:", tilesetControl.drawingShader, typeof (Shader), false) as
                    Shader;
        }
    ...
    public override void OnInspectorGUI()
    {
        ...
        OnlineMapsControlBaseEditor.CheckTarget(api, OnlineMapsTarget.tileset);
        ...
        DrawElevationGUI(tilesetControl);
    ...
    private void OnSceneGUI()
    {
        ...
        Handles.color = new Color(145f, 244f, 139f, 210f) / 255f;
