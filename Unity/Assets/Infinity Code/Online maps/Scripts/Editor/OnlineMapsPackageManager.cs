...
public class OnlineMapsPackageManager
{
    ...
    {
        if (EditorUtility.DisplayDialog("Playmaker Integration Kit", "You have Playmaker in your project?",
            "Yes, I have a Playmaker", "Cancel"))
        {
            string[] files = Directory.GetFiles("Assets", "OnlineMaps-Playmaker-Integration-Kit.unitypackage",
