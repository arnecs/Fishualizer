...
public class OnlineMapsTile
{
    ...
    {
        string server = "http://webst02.is.autonavi.com/appmaptile?style=6&x={2}&y={1}&z={0}";
        if (type == 1) server = "http://webrd03.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={2}&y={1}&z={0}";
    ...
    private void InitGoogle()
    {
        ...
        else if (type == 2) server = "http://mt1.googleapis.com/vt?pb=!1m4!1m3!1i{2}!2i{0}!3i{1}!2m3!1e0!2sm!3i295124088!3m9!2s{3}!3sUS!5e18!12m1!1e47!12m3!1e37!2m1!1ssmartmaps!4e0";
    ...
    private void InitNokia()
    {
        ...
        const string server =
            "http://{0}.maps.nlp.nokia.com/maptile/2.1/maptile/newest/{4}/{1}/{2}/{3}/256/png8?lg={5}&app_id=xWVIueSv6JL0aJ5xqTxb&app_code=djPZyynKsbTjIUDOBcHZ2g";
