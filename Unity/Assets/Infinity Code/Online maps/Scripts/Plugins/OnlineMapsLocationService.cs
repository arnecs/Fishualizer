...
// ReSharper disable once UnusedMember.Local
	private void Update () 
    {
	    try
	    {
            ...
            if (createMarkerInUserPosition && marker == null && (useGPSEmulator || position != Vector2.zero)) UpdateMarker();
    ...
    private void UpdateSpeed()
    {
        ...
        LastPositionItem p1 = lastPositions.First();
        LastPositionItem p2 = lastPositions.Last();
